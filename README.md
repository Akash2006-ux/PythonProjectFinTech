Dollar Cost Averaging is an investment strategy that an individual has a set fixed investment on a particular stock in which they can choose to invest monthly or bi-monthly. Value Cost Averaging is another investment strategy similar to Dollar Cost Averaging but the main difference is they also have a goal they want to hit with that particular stock. In this program a user enters the investment strategy DCA or VCA, then they enter the ticker symbol (the stock they want to invest in), frequency is entered, fixed amount is then entered (for DCA), but for VCA there is no fixed amount instead there is an amount to invest, and a goal.
